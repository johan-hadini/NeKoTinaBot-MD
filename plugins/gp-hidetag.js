...
let handler = async (m, { conn, text, participants }) => {
  ...
  let redes = ['https://youtube.com/channel/UC0P5Peyb-AvjXJz-jRcTYJg?sub_confirmation=1', 'https://youtube.com/channel/UC0P5Peyb-AvjXJz-jRcTYJg']
  let more = String.fromCharCode(8206)
  let masss = more.repeat(850)
  let htextos = `${text ? text : "Quiero tu leche 🥛"}`
