...
${Prefijo+t} mtc s3rl`);let i;await e.reply(MultiNK.Proces(await a.getName(e.sender)));let l=encodeURIComponent(r);try{let n=await fetchJson(`https://latam-api.vercel.app/api/ytplay?apikey=${MyApiKey}&q=${l}`),o=await getBuffer(n.logo);await a.sendMessage(e.chat,{text:`*╭─────❮ YT - AUDIO ❯─────ঐ*
*❐ ✍️ Titulo:* ${n.titulo}
