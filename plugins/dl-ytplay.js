...
`.trim(),contextInfo:{externalAdReply:{title:d.titulo,body:"⇆ㅤㅤ◁ㅤㅤ❚❚ㅤㅤ▷ㅤㅤ↻",thumbnail:p,sourceUrl:"https://youtube.com/channel/UC_Pp8pT9vbT15k5_-i6oseA?sub_confirmation=1"}}}},{quoted:t});await r.relayMessage(t.chat,u.message,{messageId:u.key.id}),s.lagnet=new Date*1,r.sendMessage(t.chat,{audio:{url:decodeURIComponent(d.descarga1)||d.descarga2},mimetype:"audio/mp4",fileName:`${d.titulo}.mp3`},{quoted:t}).catch(e=>{t.reply(`*❐─────❮ ERROR ❯─────❐*
