...
*_❤️ QUIERES AGREGAR UN GRUPO AL BOT CONTACTAME_* `,contextInfo:{"externalAdReply":{"title": `${name} Quieres agregar tu grupo :D?`,"body": `Toca aqui ;3`,"previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": await getBuffer(pp), "sourceUrl": 'https://api.whatsapp.com/send?phone=51995386439&text=Wenasss!%0ADeseo%20agregar%20mi%20grupo%20al%20comando%20del%20bot%0AAsunto%20del%20grupo%3A%20%0ALink%3A%20'}}},{})};handler.help=["wagrupos"],handler.tags=[''],handler.command=/^(wagrupos|gruposwa|grupos)$/i;export default handler;
