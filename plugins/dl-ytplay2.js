...
*🧬 ID:* ${d.id}`.trim(),footer:NombreDelBot+` 🔥`,buttons:[{buttonId:`${Prefijo}listytdl ${d.url}`,buttonText:{displayText:"[ OPCIONES DE DESCARGA ]"},type:1}],headerType:4},{quoted:e})}catch(o){e.reply(MultiNK.Error0())}};handler.help=["play2 <texto>"],handler.tags=["busqueda"],handler.command=/^(play2)$/i,handler.limit=!0;export default handler;
