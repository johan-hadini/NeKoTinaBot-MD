let handler=async(e,{conn:o,args:a})=>{try{let s=await fetchJson(`https://latam-api.vercel.app/api/covid19?apikey=${MyApiKey}&q=${a[0]?a[0]:"world"}`);if(!s.casos)return e.reply("[ ♠️ ] Sin resultados");o.sendMessage(e.chat,{text:`*[ INFORAMCION DEL COVID-19 ]*
